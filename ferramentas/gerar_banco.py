...
F1.append(i9('f1_01', 'Quando você era criança e chorava ou ficava com medo, o que mais acontecia na sua casa?', {
    8: 'Eu endurecia. Chorar ali era entregar um ponto fraco, e eu não ia ficar à mercê de ninguém.',
    9: 'Eu me acalmava sozinho e deixava passar. Virar assunto só ia pesar o clima da casa.',
    1: 'Eu engolia e me corrigia. Chorar era perder a linha, e eu tinha que dar o exemplo.',
    2: 'Eu buscava colo, e aprendi que sendo doce e prestativo esse carinho vinha.',
    3: 'Eu me recompunha rápido. Precisava continuar sendo o motivo de orgulho, não o problema.',
    4: 'Ficava a impressão de que comigo era diferente, que os outros recebiam o que faltava para mim.',
    5: 'Eu guardava para mim. Mostrar o que eu sentia era abrir uma porta que depois não fecha.',
    6: 'Eu ficava atento ao humor do adulto. Nunca sabia se vinha acolhida ou bronca.',
    7: 'Eu virava a página rápido, arrumava uma distração. Ficar ali doendo não levava a nada.',
...
F1.append(i9('f1_02', 'Quando criança, como você conseguia que prestassem atenção em você?', {
    2: 'Sendo querido e útil. Quem cuida dos outros vira alguém de quem não se abre mão.',
    3: 'Sendo motivo de orgulho. Eu valia pelo que conseguia mostrar.',
    4: 'Eu não conseguia, e isso confirmava que faltava em mim o que sobrava nos outros.',
    1: 'Sendo o certinho. Sem motivo de crítica, sobrava aprovação.',
    8: 'Batendo de frente. Se eu fosse forte, ninguém passaria por cima de mim.',
    9: 'Eu nem tentava. O que eu queria mesmo era que não houvesse tensão por minha causa.',
    5: 'Eu não disputava. Preferia o meu canto a ter que me expor para caber ali.',
    6: 'Ficando perto de quem me protegia e sendo útil para essa pessoa.',
    7: 'Animando o ambiente. Onde tem graça, tem lugar para mim.',
}, dominio='familia', eixo='fixacao', peso=1.2))

F1.append(i9('f1_03', 'Quando você pedia alguma coisa em casa (um brinquedo, ir a um lugar), o que geralmente acontecia?', {
    2: 'Eu sabia a quem pedir e como. Com quem gostava de mim, quase sempre dava certo.',
    7: 'Se vinha um não, eu dava um jeito por outro caminho. Ficar sem é que não dava.',
    8: 'Eu insistia até conseguir. Depender da boa vontade dos outros nunca foi comigo.',
    1: 'Eu nem pedia muito. Tinha que ser merecido, e na hora certa.',
    4: 'Vinha uma explicação de que não dava, e ficava a sensação de que para os outros dava.',
    5: 'Eu quase não pedia. Pedir já era ficar devendo alguma coisa a alguém.',
    6: 'Eu pedia com medo, sem saber se vinha um sim, um não ou uma bronca.',
    9: 'Eu quase não sabia o que queria. Ia no embalo do que os adultos decidiam.',
    3: 'Eu mostrava que merecia: notas, tarefas feitas, alguma coisa em troca.',
}, dominio='familia', eixo='fixacao', peso=1.2))

F1.append(i9('f1_04', 'Quando os adultos da casa discutiam, ou o clima pesava, o que você costumava fazer?', {
    9: 'Eu me desligava e esperava passar. Se eu não sentisse aquilo, não me atingia.',
    1: 'Eu ficava tenso. Alguém ali estava errado, e nada daquilo deveria estar acontecendo.',
    8: 'Eu entrava no meio, com raiva de quem estava sendo injusto com o mais fraco.',
    2: 'Eu cuidava de quem estava pior. Se o clima voltasse, eu tinha feito a minha parte.',
    6: 'Eu ficava em alerta, tentando prever até onde ia e o que ia sobrar para mim.',
    5: 'Eu saía de perto e me fechava. Aquilo consumia uma energia que eu não tinha para dar.',
    4: 'Eu sentia aquilo mais fundo que os outros, e carregava por dias.',
    3: 'Eu seguia com as minhas coisas, mostrando que comigo estava tudo bem.',
    7: 'Eu escapava para outra coisa: televisão, brincadeira, imaginação.',
}, dominio='familia'))

F1.append(i9('f1_05', 'Pensando na sua família, qual papel acabou sobrando para você?', {
    1: 'O responsável, que não podia dar motivo de crítica.',
    2: 'O querido, que cuidava dos outros e era preciso.',
    3: 'O que dava certo, o orgulho da família.',
    4: 'O que não se encaixava, e sentia isso como uma falha só dele.',
    5: 'O que não pedia nada, e também não queria que exigissem nada dele.',
    6: 'O leal, que segurava as pontas e não podia decepcionar.',
    7: 'O que aliviava o clima e trazia leveza.',
    8: 'O forte, que resolvia e protegia.',
...
F1.append(i9('f1_07', 'Alguém importante para você manda uma mensagem: “precisamos conversar”, sem dizer o assunto. O que passa na sua cabeça até a conversa?', {
    6: '“O que será que aconteceu?” Já imagino três cenários, quase todos ruins.',
    1: 'Reviso o que pode ter saído errado. Se a falha for minha, já começo a me cobrar.',
    3: 'Penso em como me sair bem e não ficar mal na foto.',
    8: 'Se for encrenca, eu encaro. O que me incomoda é ficar na mão de alguém.',
    9: 'Empurro para depois. Nem penso no assunto até chegar lá.',
    4: 'Já sinto que é comigo, que vão apontar em mim aquilo que eu já suspeito.',
    2: 'Penso em tudo o que já fiz por essa pessoa. Seria injusto ela vir com cobrança.',
    5: 'Me incomoda ser pego sem tempo de me preparar, exposto sem ter escolhido.',
    7: 'Provavelmente não é nada. Já estou pensando em outra coisa.',
}, dominio='geral', eixo='paixao'))

F1.append(i9('f1_08', 'Você está em uma fila e alguém passa na sua frente, de propósito, e olha para você. O que você faz?', {
    8: 'Falo na hora. Deixar passar seria aceitar que podem me passar para trás.',
    1: 'Fico indignado. Não é sobre mim: é sobre a pessoa estar fazendo uma coisa errada.',
    9: 'Deixo passar. Não vale virar um atrito por causa disso.',
    6: 'Fico tenso medindo o risco. Se eu falar, dá confusão. Se eu não falar, fico remoendo.',
    3: 'Não faço cena. Brigar por causa de fila me deixaria mal diante dos outros.',
    2: 'Fico indignado que façam isso comigo, logo eu, que sempre tenho consideração pelos outros.',
    4: 'Sinto como desfeita pessoal, como se eu não valesse o bastante para ser respeitado.',
    5: 'Não falo nada. Não vou gastar a minha energia com um estranho.',
    7: 'Faço um comentário irônico e sigo. Não vou estragar o meu dia com isso.',
}, eixo='paixao'))

F1.append(i9('f1_09', 'Um amigo desmarca em cima da hora pela terceira vez seguida. O que acontece?', {
    2: 'Fico magoado. Eu sempre estou lá quando ele precisa, e isso cria uma conta que ele não paga.',
    8: 'Falo na cara, ou simplesmente paro de chamar. Não fico na mão de ninguém.',
    1: 'Acho um desrespeito com o tempo dos outros, mesmo que eu não diga nada.',
    9: 'Fico chateado um pouco e deixo passar. Ele deve ter os motivos dele.',
    4: 'Penso que ele prefere a companhia de outras pessoas, e isso mexe comigo mais do que deveria.',
    6: 'Fico com a pulga atrás da orelha: será que ele está me evitando, ou aconteceu alguma coisa?',
    5: 'Dá até um alívio. A noite volta a ser minha, e sai mais barato para mim.',
    3: 'Já preencho o horário com outra coisa útil.',
    7: 'Chamo outra pessoa ou invento outro programa. Não fico parado na frustração.',
...
F1.append(i9('f1_10', 'É sábado à noite, você está em casa e não recebeu nenhum convite. Como é isso para você?', {
    5: 'Ótimo. É quando eu recupero o que os outros gastam de mim durante a semana.',
    9: 'Fico numa boa. Vou levando a noite sem pensar muito.',
    7: 'Começo a imaginar o que dá para fazer. Ficar sem nada me incomoda.',
    4: 'Bate a sensação de estar de fora, como se os outros tivessem algo que eu não tenho.',
    2: 'Estranho. Eu estou sempre disponível para os outros, e ninguém lembrou de mim.',
    6: 'Fico bem, mas se ninguém chamou, começo a me perguntar por quê.',
    3: 'Aproveito para adiantar alguma coisa. Tempo parado me dá sensação de ficar para trás.',
    1: 'Uso o tempo para colocar em ordem o que está pendente.',
    8: 'Se eu quiser companhia, eu chamo. Não fico esperando ser lembrado.',
}, eixo='paixao'))

F1.append(i9('f1_11', 'Numa roda de conversa, alguém critica uma coisa que você fez, na frente de todo mundo. O que acontece primeiro dentro de você?', {
    3: 'Penso em como recuperar a imagem ali mesmo.',
    8: 'Sobe uma quentura. Ninguém vai me diminuir na frente dos outros.',
    1: 'Checo se a crítica é justa. Se for, dói mais, porque eu deveria ter feito melhor.',
    4: 'Sinto vergonha, e aquilo confirma o que eu já desconfiava sobre mim.',
    6: 'Desconfio da intenção da pessoa e de quem mais está do lado dela.',
    2: 'Me magoo. Depois de tudo o que eu faço, era para terem mais consideração comigo.',
    9: 'Fico meio anestesiado. Só depois percebo o quanto aquilo me incomodou.',
    5: 'Me fecho e respondo o mínimo. Ali eu não entrego nada.',
    7: 'Levo na leveza e faço uma piada. Não quero estragar o clima.',
}, dominio='amizade', eixo='paixao'))

F1.append(i9('f1_12', 'Você chega a uma festa onde conhece pouca gente. O que você faz nos primeiros vinte minutos?', {
    3: 'Procuro as pessoas que valem a pena conhecer ali.',
    2: 'Puxo conversa e me aproximo de quem parece precisar de companhia.',
    7: 'Vou onde está mais animado. Vim para aproveitar.',
    6: 'Fico perto de quem eu conheço até entender o clima do lugar.',
    9: 'Acompanho quem me levou e vou no ritmo do grupo.',
    4: 'Fico meio de fora, sentindo que não sou daquele lugar.',
    5: 'Fico num canto observando. Prefiro olhar a ter que me expor.',
    8: 'Chego junto e falo com quem eu quiser. Não fico esperando ser aceito.',
    1: 'Fico um pouco rígido, achando as conversas meio sem propósito.',
}, dominio='amizade'))
...
F1.append(i9('f1_13', 'Alguém importante para você some por uma semana, sem explicação. O que se passa?', {
    ...
    6: 'Fico remoendo o que houve e se ainda dá para confiar.',
    2: 'Fico magoado e espero que ela perceba a falta que eu faço.',
    8: 'Cobro direto quando aparecer. Sumir comigo tem consequência.',
    9: 'Levo numa boa. Cada um tem o seu tempo.',
    1: 'Acho falta de consideração, mesmo entendendo que pode ter motivo.',
    5: 'Não estranho. Some quem quer, e eu também preciso dos meus sumiços.',
    3: 'Me ocupo e sigo. Quando voltar, a gente resolve.',
    7: 'Sigo a minha vida, que está cheia de coisas boas.',
...
F1.append(i9('f1_14', 'Você recebe um dinheiro inesperado, o suficiente para um mês de despesas. O que você faz com ele?', {
    5: 'Guardo quase tudo. Dinheiro parado é autonomia, e autonomia é não precisar de ninguém.',
    6: 'Coloco na reserva. É para quando alguma coisa der errado.',
    7: 'Já penso numa viagem ou em algo que eu queria há tempos.',
    2: 'Uso boa parte com quem eu gosto. Gosto de ser quem proporciona.',
    3: 'Invisto em algo que me faça crescer: curso, aparência, equipamento.',
    1: 'Pago o que está pendente. Primeiro o dever, depois o resto.',
    8: 'Gasto com o que eu quero, e quero agora.',
    9: 'Deixo na conta e vou usando no conforto do dia a dia, sem plano.',
    4: 'Compro algo que tenha a minha cara, algo que ninguém mais teria.',
}))
...
INST = [
    f2('f2i_01', 'Alguém próximo quebra, pela segunda vez, um combinado que tinha com você. O que você faz?', [
        (8, 'Falo na hora. Quem deixa passar uma vez ensina que pode de novo.',
            'Não discuto mais. A pessoa perde o acesso a mim e sente isso.'),
        (9, 'Deixo passar de novo. Brigar custa mais caro para mim do que engolir, mas vai entalando.',
            'Não falo nada e por dentro paro de contar com a pessoa. Discutir não muda ninguém.'),
        (1, 'Explico qual era o combinado. O que me pega não é o transtorno, é a pessoa achar que pode.',
    ...
    f2('f2i_06', 'Em uma discussão de família que esquenta, o que você faz?', [
        (8, 'Aumento o tom e tomo a frente. Quem hesita ali vira alvo.', 'Entro na frente de quem está sendo atacado.'),
        (9, 'Concordo com todos e me desligo. Se eu não sentir a briga, ela não me atinge.', 'Tento acalmar os dois lados. Aquele clima dentro de casa é insuportável para mim.'),
    ...
    f2('f2i_12', 'Numa discussão com conhecidos, com outras pessoas olhando, o que você faz?', [
        (8, 'Enfrento na frente de todos. Recuar ali seria admitir que podem passar por cima de mim.',
            'Defendo quem está do meu lado e deixo claro que quem mexer com eles lida comigo.'),
        (9, 'Cedo e procuro um meio-termo, só para aquele mal-estar acabar.',
            'Fico quieto ali e continuo fazendo do meu jeito depois.'),
        (1, 'Mantenho a compostura e defendo o que é correto.',
            'Aponto o erro na frente de todos, porque aquilo não pode passar.'),
    ], dominio='amizade', gemeo='gemeo_conflito_intensidade', **EMO),
    ...
    f2('f2i_10', 'Você acabou de receber uma notícia que mexeu muito com você. O que você faz na hora seguinte?', [
        (8, 'Ajo na hora: ligo, resolvo, mexo em alguma coisa. Parado eu sinto demais.', 'Saio, bebo, treino, trabalho dobrado. Preciso descarregar.'),
        (9, 'Como alguma coisa, ligo a TV. Se eu não encostar naquilo, uma hora passa.', 'Sigo a rotina como se nada fosse. É a rotina que me segura de pé.'),
        (1, 'Transformo em tarefa: organizo, resolvo o que dá. Ficar sentindo não conserta nada.', 'Canalizo para algo útil ou para uma causa.'),
    ], **PAI),
    ...
    f2('f2i_15', 'Um grupo precisa decidir algo e ninguém decide. O que você faz?', [
        (8, 'Decido e toco. Depois a gente ajusta o que estiver errado.',
            'Distribuo as tarefas e digo quem faz o quê. Se eu não assumir, alguém assume por mim.'),
        (9, 'Espero alguém decidir e vou com a maioria. Ter uma posição só criaria atrito.',
    ...
    ], dominio='amizade', eixo='fixacao', peso=1.5),
    ...
    f2('f2i_17', 'Como costuma ser o seu sábado?', [
        (8, 'Cada sábado é diferente, do jeito que der vontade. Odeio agenda no fim de semana.',
            'Puxo alguém para alguma coisa, e costuma ir longe. Meio-termo me entedia.'),
        (9, 'Quase sempre igual. Mudar exige uma energia que eu não quero gastar.',
            'Começo várias coisas e termino no sofá, sem saber direito o que eu queria mesmo.'),
        (1, 'Tenho uma lista e cumpro. Descansar com pendência me deixa em dívida.',
            'Arrumo o que ficou torto na semana. Aquilo fica me chamando até eu resolver.'),
    ], **PAI),
]
...
EMOC = [
    ...
    f2('f2e_03', 'Você está muito triste e alguém toca no assunto. O que você faz?', [
        ...
        (3, 'Digo que está tudo bem e sigo funcionando. Aparecer quebrado é o que eu menos quero.', 'Desconverso e volto para o que eu estava fazendo. Produzir me tira dali.'),
        (4, 'Falo, e vai fundo. Sentir aquilo inteiro é a coisa mais verdadeira que eu tenho.', 'Corto o assunto. Reclamar é fraqueza, eu aguento.'),
    ], **FIX),
    ...
    f2('f2e_05', 'Você fez uma coisa com cuidado para alguém, e não era o que a pessoa esperava. O que vem primeiro?', [
        (2, 'Medo de que gostem menos de mim.', 'Indignação: depois de tudo que eu faço, ainda cobram?'),
        (3, 'Pressa de consertar e mostrar que dou conta.', 'Vontade de me esforçar o dobro, calado, até ninguém ter o que dizer.'),
    ...
    f2('f2e_10', 'Você acorda no domingo sem nada marcado e sem ninguém por perto. Como é a primeira hora?', [
        (2, 'Já estou mandando mensagem para alguém. Sozinho, eu não sirvo para nada.', 'Me incomoda que ninguém tenha lembrado de mim.'),
        (3, 'Faço uma lista e começo a adiantar coisas. Parado, sinto que estou ficando para trás.', 'Arrumo a casa, resolvo pendências. Sem estar produzindo, é como se eu não valesse nada.'),
    ...
    f2('f2e_17', 'Você contou uma história para um grupo ontem. Como foi?', [
        (2, 'Coloquei emoção e gesto, e a mesa foi junto. Eu gosto de ser quem move as pessoas.',
            'Exagerei um pouco para a história ficar melhor.'),
        (3, 'Contei do jeito que funciona. Já sei o efeito que faz.',
            'Fui direto ao ponto. O que conta é o efeito que faz, não o enfeite.'),
...
MENT = [
    f2('f2m_01', 'Você está inseguro com uma decisão importante e ela não sai da sua cabeça. O que você faz?', [
        (5, 'Me recolho e resolvo sozinho. Pedir ajuda já me deixa devendo alguma coisa.', 'Falo com a única pessoa em quem confio de verdade, e com mais ninguém.'),
        ...
        (7, 'Deixo as opções em aberto. Fechar uma é abrir mão de todas as outras.',
    ...
    f2('f2m_12', 'Alguém conta a você uma versão de uma história que não fecha. O que você faz?', [
        (5, 'Guardo a dúvida para mim e vou juntando informação. Perguntar seria entregar o que eu penso.', 'Estudo até dominar o assunto. Entender é a única segurança que não depende de ninguém.'),
    ...
    f2('f2m_13', 'Você está sozinho em casa à noite e ouve um barulho estranho. O que faz?', [
        (5, 'Fico parado, escutando, avaliando. Agir sem entender é o pior jeito de gastar energia.', 'Tranco tudo e volto para o meu canto, que é onde nada me alcança.'),
...
CRUZ = [
    ...
    cz('fx_86d', 8, 6, 'Chega alguém com autoridade sobre você e fama de durão. Como você age na primeira semana?',
       'Testo na prática: faço do meu jeito e vejo se a pessoa reage.',
       'Observo tudo: se é coerente, se cumpre o que diz, com quem se alia.'),
    ...
    cz('fx_82b', 8, 2, 'Você quer muito uma pessoa. Como você age?',
       'Vou direto e digo o que quero. Rodeio é perder tempo e terreno.',
    ...
    cz('fx_13a', 1, 3, 'Você está fazendo uma coisa que ninguém vai ver. Quanto capricho você coloca?',
       'Todo. É o certo, e mesmo sem ninguém ver, eu veria.',
       'O suficiente. Guardo o esforço para o que vai aparecer.'),
    cz('fx_13b', 1, 3, 'Uma coisa que você fez recebeu um elogio na frente de todos. O que acontece?',
    ...
    cz('fx_95a', 9, 5, 'Você passou a noite sozinho em casa. O que fez?',
       'Deixei a noite passar sem perceber, e no fim nem sei direito o que fiz.',
       'Aproveitei para ficar comigo, sem ninguém pedindo nada. É assim que eu recupero a energia.'),
    cz('fx_95b', 9, 5, 'Num grupo grande de pessoas, como você fica?',
       'Vou no embalo do grupo, sem esforço, quase esquecendo de mim.',
       'Mesmo participando, fico à parte por dentro, guardando energia, e saio assim que dá.'),
    ...
    cz('fx_93a', 9, 3, 'Você se dedicou muito a uma coisa de um grupo (uma festa, uma viagem, um evento), e deu certo. O que você quer?',
    ...
    cz('fx_27a', 2, 7, 'Numa mesa de dez pessoas, qual costuma ser o seu lugar?',
       'Cuidando de alguém, puxando quem ficou de fora. É ali que eu me sinto necessário.',
       'Contando história, animando a mesa. Onde está bom, eu não fico de fora.'),
    ...
    cz('fx_37a', 3, 7, 'Você está com várias coisas começadas ao mesmo tempo. Por quê?',
       'Cada uma me leva a algum lugar. Tudo tem propósito.',
    ...
    cz('fx_45a', 4, 5, 'Você passou três dias sem falar com ninguém. Como foi?',
       ...
       'Foi ótimo. Sozinho eu não gasto nada de mim, e é assim que eu reponho.'),
    ...
    cz('fx_35a', 3, 5, 'Uma coisa prática precisa ficar pronta esta semana (uma mudança, uma festa, um conserto). Como você se sai?',
       'Eu resolvo: ligo, corro atrás, entrego. Eu valho pelo que eu entrego.',
       'Eu entendo o problema melhor que a maioria, mas colocar de pé é outra história.'),
    cz('fx_35b', 3, 5, 'Você precisa se apresentar e falar de si para um grupo de desconhecidos. E aí?',
       'Eu me apresento bem. Sei causar boa impressão.',
       'Evito. Falar de mim ali é me expor sem ter escolhido o quanto.'),
    ...
    # Pares de triades diferentes que nao tinham nenhum item cruzado.
    # 5 x 8: os dois nao dependem de ninguem, mas o 8 avanca e toma, e o 5 se retira
    # e dispensa (Naranjo: luxuria como expansao; avareza como retencao).
    cz('fx_58a', 5, 8, 'Você quer muito uma coisa que depende de outra pessoa liberar. O que você faz?',
       'Prefiro abrir mão, ou dar um jeito sozinho, a ter que pedir e depender.',
       'Vou atrás e pressiono até conseguir. Se eu quero, eu tomo a frente.'),
    cz('fx_58b', 5, 8, 'Alguém próximo passa de um limite seu. O que acontece dentro de você?',
       'Eu me recolho. Fecho a porta por dentro e passo a dar menos de mim para essa pessoa.',
       'Eu cresço para cima. A resposta sai na hora, e a pessoa percebe que passou do ponto.'),
    # 1 x 2: no 1 o motor e o dever e a correcao; no 2, o vinculo e ser querido.
    cz('fx_12a', 1, 2, 'Um amigo pede um favor que atrapalha os seus planos. O que pesa na sua decisão?',
       'Se é certo ajudar. Se eu prometi ou se é justo, eu faço, mesmo sem vontade.',
       'O que ele vai sentir por mim. Não quero que pense que eu falhei com ele.'),
    cz('fx_12b', 1, 2, 'Você fez uma coisa muito bem feita, e ninguém comentou. O que fica?',
       'Fico revendo se estava mesmo bom, ou se tinha algum defeito que eu não vi.',
       'Uma pontada. Eu queria que tivessem percebido o quanto eu me dediquei.'),
    # 2 x 5: o 2 se move na direcao do vinculo; o 5 se retira dele.
    cz('fx_25a', 2, 5, 'Um amigo está passando por um momento difícil. O que você faz?',
       'Fico perto, ligo, levo alguma coisa, me faço presente, mesmo que ele não tenha pedido.',
       'Ofereço o que posso de longe e respeito o espaço dele, como gostaria que respeitassem o meu.'),
    cz('fx_25b', 2, 5, 'Numa festa, alguém que você mal conhece começa a contar a vida inteira para você. Como você fica?',
       'Gosto. Me sinto especial por ter sido escolhido para ouvir.',
       'Fico incomodado. Aquilo é mais proximidade do que eu queria dar.'),
]
...
F3 = [
    f3('f3_01', 'Você recebeu hoje uma notícia muito boa. Qual é o seu primeiro impulso?',
       'Pensar no que ela resolve na minha vida e deixar as coisas mais seguras.',
       'Dividir com as pessoas do meu meio e ver o que isso muda para nós.',
       'Me jogar de cabeça: contar para a pessoa que mais importa, ou mergulhar no que essa notícia abre.', eixo='paixao'),
    f3('f3_02', 'Em que a sua cabeça fica quando você está no chuveiro, sem querer pensar em nada?',
       'No que eu preciso resolver para ficar tranquilo: contas, saúde, as coisas da casa.',
       'Numa conversa do grupo, em quem falou o quê, no meu lugar ali.',
       'Numa pessoa ou numa ideia que me fisgou, repassando cada detalhe.', eixo='fixacao', peso=1.3),
    f3('f3_03', 'Você tem uma noite livre e energia. Onde ela vai?',
       'Uso para deixar a minha vida em ordem. Com pendência aberta eu não descanso.',
       'Uso com gente. Muito tempo longe e eu começo a me sentir fora das coisas.',
       'Uso inteira numa coisa só, a que está me pegando agora, e nem vejo a hora passar.'),
    f3('f3_04', 'Numa festa com muita gente, onde você acaba?',
       'Num canto confortável, poupando energia. Aquilo tudo me cansa mais do que me anima.',
       'Circulando, medindo quem é quem e onde eu me encaixo ali.',
       'Numa conversa longa com uma pessoa só, e o resto da festa deixa de existir.', dominio='amizade', opcional=True),
    f3('f3_05', 'Um amigo íntimo diz que você exagera em alguma área. Qual crítica você já ouviu?',
       ...
       '“Você se joga inteiro numa coisa só, uma pessoa ou uma paixão, e o resto some.”', eixo='fixacao', peso=1.3, indireto=True),
    ...
    f3('f3_07', 'Você passou por semanas difíceis e finalmente tem um fim de semana. O que mais ajuda você a se recuperar?',
       'Ter o básico de pé: sono, corpo, contas. Com isso resolvido, eu volto.',
       'Estar entre os meus e sentir que tenho o meu lugar ali.',
       'Uma coisa só, forte o bastante para me tirar do resto: alguém, ou algo que me acenda.', opcional=True),
    f3('f3_08', 'Qual exagero dos outros você entende mais facilmente?',
       ...
       'Quem se entrega inteiro a uma pessoa ou a uma paixão, e esquece o resto.', eixo='fixacao', peso=1.3, indireto=True, opcional=True),
    f3('f3_09', 'Você chega a um lugar novo. O que você repara primeiro, sem querer?',
       ...
       'Quem ou o que me atrai de imediato ali. A minha atenção vai sozinha para lá.', eixo='paixao'),
    ...
    f3('f3_11', 'Numa semana difícil, qual preocupação volta mais vezes à sua cabeça?',
       ...
       'A intensidade que eu posso perder: uma relação, ou aquilo em que estou mergulhado de corpo e alma.', eixo='fixacao', peso=1.3),
    f3('f3_12', 'Numa viagem com amigos, o que faria a viagem dar errado para você?',
       ...
       'Tudo morno: nenhum momento, conversa ou experiência que me pegasse de verdade.', dominio='amizade', opcional=True),
]
F3_DES = [
    item('f3d_as', 3, 'Você vai se mudar e tem duas opções de lugar. Qual argumento pesa mais?', [
        (SP, 'Segurança, conforto e contas que eu consigo manter.'),
        (SO, 'Ficar perto das pessoas e do grupo de que eu faço parte.'),
    ], eixo='fixacao', peso=1.4, separa=[SP, SO]),
    item('f3d_sx', 3, 'Você só pode manter uma coisa: o seu grupo, ou aquilo que mais acende você (uma pessoa, uma paixão). Qual?', [
        (SO, 'O grupo. Sem ele eu fico sem chão.'),
        (SX, 'O que me acende. Sem isso nada tem graça.'),
    ...
    item('f3d_ax', 3, 'Você está em crise. Para onde você corre?', [
        ...
        (SX, 'Para a pessoa mais importante para mim, ou para aquilo que me absorve inteiro.'),
...
F4 = {
 ...
 3: [f4(3, 'a', 'Você vai a um encontro onde vai estar muita gente importante para você. Qual é o seu objetivo ali?',
        'Resolver o que eu preciso e sair com as coisas encaminhadas.',
 ...
 5: [f4(5, 'a', 'Você teve um dia muito exigente. O que faz você voltar ao normal?',
        ...
        'Uma conversa sem pressa com a única pessoa em quem confio, ou algo que me emocione de verdade.'),
 ...
 6: [f4(6, 'a', 'Você está com medo de verdade. O que faz?',
     ...
     f4(6, 'b', 'Alguém com autoridade sobre você cometeu um erro claro. O que você faz?',
        'Não falo nada. Preciso da boa relação com essa pessoa.',
        'Aponto o que seria o correto, sem atacar a pessoa.',
 ...
 8: [f4(8, 'a', 'Um problema sério cai no seu colo. Como você lida com ele?',
     ...
     f4(8, 'c', 'Sexta à noite, depois de um dia difícil. O que é prazer para você?',
        ...
        'Intensidade, sem limite: alguém ou alguma coisa que me pegue por inteiro.')],
